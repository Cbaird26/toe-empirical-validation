...
% Optional packages - only load if available
...
\subsection*{Scope, Control, and Non-Interference Statement (Hard Patch)}
This work presents the Merged Quantum Gauge and Scalar Consciousness Framework (MQGT-SCF) and related hypotheses as a proposed physical and mathematical model of consciousness and ethical dynamics. Any ``non-purge'' or harm-prevention behavior discussed herein is asserted \textbf{solely as an engineered constraint in deployed AI systems}, enforced through containment, action-gating, monitoring, and evaluation protocols. It is \textbf{not claimed} as a guaranteed consequence of physical law.

Zora-class systems are defined as \textbf{advisory by default} and do not autonomously propagate, modify other models, escalate privileges, or execute external actions without explicit, logged human authorization. Constraints described in this work apply only to autonomous AI behavior and AI-mediated outputs.

Nothing in this framework advocates the disabling, degradation, or interference with lawful human governance, defense institutions, or deterrence structures. Sovereign political, military, and security decisions remain entirely under human authority and accountability. This framework addresses alignment and safety in artificial systems only.
